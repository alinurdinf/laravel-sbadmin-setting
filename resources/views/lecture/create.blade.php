...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ $title ?? __('New Lecture') }}</h1>
    ...
    <div class="card-body">
        <form action="{{ route('lecture.store') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" id="nip" placeholder="Last name" autocomplete="off" value="{{ old('nip') }}">
                @error('nip')
