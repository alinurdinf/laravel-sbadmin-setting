    ...
    <div class="card-body">
        <form action="{{ route('basic.store') }}" method="post">
            ...
            <div class="form-group">
                <label for="identity_number">NIP / NIM</label>
                <input type="text" class="form-control @error('identity_number') is-invalid @enderror" name="identity_number" id="identity_number" placeholder="NIP or NIM" autocomplete="off" value="{{ old('identity_number') }}">
